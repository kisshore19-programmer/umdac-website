      ...
      <div className="mx-auto grid w-full max-w-6xl overflow-hidden rounded-2xl border-4 border-slate-900 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 shadow-[8px_8px_0px_0px_rgba(15,23,42,1)] lg:grid-cols-2">
        ...
        <div className="p-6 md:p-10">
          <div className="mb-8 flex justify-between items-start">
            ...
            <Link
              href="/admin"
              className="rounded-lg border-2 border-slate-900 bg-white px-3 py-1.5 text-xs font-black uppercase tracking-wider text-slate-900 shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] transition hover:-translate-y-0.5 hover:shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] focus:outline-none"
            >
              Admin Login
            </Link>
          </div>
