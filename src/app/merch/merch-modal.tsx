  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-2xl" style={{ animation: 'merch-modal-in 0.18s ease-out both' }}>
        <div className="max-h-[90vh] overflow-y-auto overflow-hidden rounded-2xl border-4 border-slate-900 bg-white shadow-[8px_8px_0px_0px_rgba(15,23,42,1)] dark:border-slate-800 dark:bg-slate-900 dark:shadow-[8px_8px_0px_0px_rgba(0,0,0,0.8)]">

          {/* Image area */}
          <div className="relative h-72 w-full bg-slate-100 sm:h-80 dark:bg-slate-800">
            {item.image_url ? (
              <Image
                src={item.image_url}
                alt={item.name}
            ...
            <button
              ...
              type="button"
              onClick={onClose}
              className="absolute right-4 top-4 flex h-9 w-9 items-center justify-center rounded-full border-2 border-slate-900 bg-white shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] transition hover:bg-slate-100 active:translate-y-px dark:border-slate-700 dark:bg-slate-800 dark:hover:bg-slate-700"
              aria-label="Close modal"
            >
              <svg className="h-4 w-4 text-slate-900 dark:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
          ...
          <div className="p-6 sm:p-8">
            ...
            {/* Name */}
            <h2 className="mt-3 text-2xl font-black uppercase tracking-tight text-slate-900 dark:text-white sm:text-3xl">
              {item.name}
            </h2>
